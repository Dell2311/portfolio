...
export const BentoGridItem = ({
  ...
  const leftLists = ["Delphi", "Javascript", "CSS"];
  const rightLists = ["Typescript", "HTML"];
  ...
  const handleCopy = () => {
    const text = "delld2311@gmail.com";
  ...
  return (
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          <div className="font-sans font-extralight md:max-w-32 md:lg:text-base text-sm text-[#C1C2D3] z-10">
            {description}
          </div>
          <div
